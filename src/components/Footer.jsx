      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="hidden md:flex space-x-4 absolute left-1/2 transform -translate-x-1/2">
            <a href="https://twitter.com/yourusername" className="hover:text-blue-400 transition duration-300">
              <FaXTwitter className="h-6 w-6" />
            </a>
            <a href="https://t.me/yourusername" className="hover:text-blue-400 transition duration-300">
